...
export default function CartPage() {
  ...
  return (
    <SectionContainer>
      ...
      <div className="rounded-md border-2 border-black07">
        <SectionContainer>
          <div className="flex flex-col gap-16">
            <p>Cart summary</p>
            <div role="radiogroup" className="flex h-full flex-col gap-16">
              <div
                className={cx(
          ...
          <div className="pb-24">
            <div className="divider flex justify-between py-12">
              <p>Subtotal</p>
              <p className="">{formatPrice(totalCartPrice)} </p>
            </div>
            <div className="flex justify-between py-12">
              <p>Total</p>
              <p className="">{formatPrice(totalSum)} </p>
            </div>
          </div>
          <Link href="/checkout">
            <Button
